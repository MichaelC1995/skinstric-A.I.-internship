    ...
    return (
        <div className="min-h-[90vh] flex flex-col items-center justify-center bg-white text-center">
            ...
            <div className="relative flex flex-col items-center justify-center mb-40 w-full h-full">
                ...
                <p className="text-sm text-gray-400 tracking-wider uppercase mb-1 pointer-events-none">CLICK TO TYPE</p>
                    <input
                ...
                <a className="inset-0" aria-label="Back" href="/">
                    <div>
                        ...
                        <div className="group hidden sm:flex flex-row relative justify-center items-center">
                            <div
                                className="w-12 h-12 hidden sm:flex justify-center rotate-45 scale-[0.85] group-hover:scale-[0.92] ease duration-300"></div>
                            <img
                                src="/back-icon-text-shrunk.jpg"
                                className="absolute left-[15px] bottom-[13px] scale-[0.9] hidden sm:block group-hover:scale-[0.92] ease duration-300"
                            />
